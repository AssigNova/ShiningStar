...
// SidebarMenuSkeleton: a valid React component for menu skeleton
...
function SidebarMenuSkeleton({ showIcon = false, width = 80, className }: SidebarMenuSkeletonProps) {
  return (
    <div data-sidebar="menu-skeleton" className={cn("flex h-8 items-center gap-2 rounded-md px-2", className)}>
