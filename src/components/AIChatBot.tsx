...
import { MessageCircle, X, Send, Bot, User, Zap, HelpCircle, Search, Upload, BarChart3, BookOpen, Sparkles, ArrowRight, ExternalLink, ChevronDown } from 'lucide-react';
...
export function AIChatBot({ 
  ...
  const generateAIResponse = (input: string): Message => {
    ...
    return {
      id: Date.now() + 1,
      content: "I'd love to help you with that! Here are some popular topics I can assist with:\n\n🎯 **Popular Help Topics:**\n• Creating and uploading submissions\n• Understanding the competition\n• Improving your rankings\n• Platform navigation and features\n\nWhat specific area would you like to explore?",
      sender: 'bot',
      timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
      type: 'interactive',
      actions: [
