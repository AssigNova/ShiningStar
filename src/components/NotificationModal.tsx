import { X, Heart, MessageCircle, Upload, Trophy, Bell, Clock } from 'lucide-react';
...
export function NotificationModal({ isOpen, onClose, user }: NotificationModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md max-h-[80vh] p-0">
        <DialogHeader className="p-6 pb-4 border-b">
          ...
          <DialogDescription>
            View your recent notifications and updates from the platform.
          </DialogDescription>
        </DialogHeader>
